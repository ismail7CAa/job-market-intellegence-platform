...
### 9. Ingestion batches needed persistence
...
### 10. Expired listings needed explicit state
...
### 11. Similar jobs needed persisted matching signals
...
### 12. Database changes needed real migrations
...
### 13. Local SQLite schemas drifted from the SQLAlchemy model
