...
### 6. Ingestion needed one orchestration path
...
### 7. Expired listings needed explicit state
...
### 8. Similar jobs needed persisted matching signals
...
### 9. Database changes needed real migrations
...
### 10. Local SQLite schemas drifted from the SQLAlchemy model
