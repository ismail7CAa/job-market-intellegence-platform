...
### 7. Ingestion needed one orchestration path
...
### 8. Expired listings needed explicit state
...
### 9. Similar jobs needed persisted matching signals
...
### 10. Database changes needed real migrations
...
### 11. Local SQLite schemas drifted from the SQLAlchemy model
