...
PUBLIC_BASE_URL=http://$EC2_HOST:8000
CORS_ALLOW_ORIGINS=["http://$EC2_HOST:8000"]
INGESTION_ENABLED=false
INGESTION_API_TOKEN=
RATE_LIMIT_REQUESTS=600
RATE_LIMIT_WINDOW_SECONDS=60
PRODUCTION_DATA_PATH=/app/data/job_postings_production.csv
TRAINING_DATA_PATH=/app/data/job_postings_training.csv
ENVEOF
