...
JOB_POSTINGS_SCHEMA = pa.DataFrameSchema(
    {
        ...
        "salary_period": pa.Column(str, nullable=True, required=False, coerce=True),
        "salary_is_estimated": pa.Column(bool, nullable=True, required=False, coerce=True),
        "salary_confidence": pa.Column(
            float,
            Check(lambda s: s.isna() | ((s >= 0) & (s <= 1)), element_wise=False),
            nullable=True,
            required=False,
            coerce=True,
        ),
        "job_type": pa.Column(str, nullable=False),
        "employment_type": pa.Column(str, nullable=True, required=False, coerce=True),
        ...
        "posted_at": pa.Column(pa.DateTime, nullable=True, required=False, coerce=True),
        "expires_at": pa.Column(pa.DateTime, nullable=True, required=False, coerce=True),
        "last_seen_at": pa.Column(pa.DateTime, nullable=True, required=False, coerce=True),
        "is_expired": pa.Column(bool, nullable=True, required=False, coerce=True),
        "source": pa.Column(str, nullable=False),
        "source_posting_id": pa.Column(str, nullable=True, required=False, coerce=True),
        "url": pa.Column(str, nullable=True, required=False, coerce=True),
        "application_url": pa.Column(str, nullable=True, required=False, coerce=True),
        "company_career_url": pa.Column(str, nullable=True, required=False, coerce=True),
        "country": pa.Column(str, nullable=True, required=False, coerce=True),
        "city": pa.Column(str, nullable=True, required=False, coerce=True),
        "federal_state": pa.Column(str, nullable=True, required=False, coerce=True),
        ...
        "occupation_group": pa.Column(str, nullable=True, required=False, coerce=True),
        "experience_level": pa.Column(str, nullable=True, required=False, coerce=True),
        "source_legal_basis": pa.Column(str, nullable=True, required=False, coerce=True),
        "ingestion_batch_id": pa.Column(str, nullable=True, required=False, coerce=True),
    },
