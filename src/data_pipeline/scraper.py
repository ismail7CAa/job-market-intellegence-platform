    ...
    def _get_mock_data(self, keyword: str, limit: int) -> List[JobPosting]:
        ...
        mock_jobs = [
            JobPosting(
                ...
                location=["Berlin, Germany", "Munich, Germany", "Hamburg, Germany"][i % 3],
                salary_min=65000 + (i * 4000),
                salary_max=85000 + (i * 6000),
                job_type="Full-time",
    ...
    def _get_mock_data(self, limit: int) -> List[JobPosting]:
        ...
        mock_jobs = [
            JobPosting(
                ...
                company=f"German Data Company {i}",
                location=["Berlin, Germany", "Frankfurt, Germany", "Cologne, Germany"][i % 3],
                salary_min=56000 + (i * 3500),
                salary_max=76000 + (i * 5000),
                job_type="Full-time",
